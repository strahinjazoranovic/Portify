    ...
    export function AdminCardProject({ onOpenModal }: { onOpenModal: () => void }) {
            ...
            <div className="mt-2 flex flex-wrap justify-center gap-6">
                ...
                {loading ? (
                    <>
                        ...
                        {Array.from({ length: 3 }).map((_, index) => (
                            ...
                            >
                                <div className="flex h-54 justify-center p-6">
                ...
                projects.length === 0 ? (
                    ...
                    <>
                        ...
                        {/* Add new project with opening modal when you click on this */}
